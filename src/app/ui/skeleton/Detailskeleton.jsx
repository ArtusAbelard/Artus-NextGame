...
//this page is skelleton for details section

export default function Detailskeleton(props) {
    const color = useSelector((state) => state.color) //import color for darkmode
    
    return (
       
          <div className={`pt-16 w-[100%] min-h-[895px] flex bg-[#1e1e1e] justify-center items-center flex-wrap gap-10 bgdetail max-[426px]:pt-0  ${color.actual==true?"invert":""}`}> {/* darkmode */}
