...
export default function Homepage({products}) { 
    ...
    return (
        <div className={` h-[42.4rem] z-0 max-[1025px]:h-[70rem] max-[425px]:h-[70rem] max-[425px]:flex max-[425px]:items-center max-[425px]:justify-center  ${color.actual==true?"invert ":""}`}>
          
            <div className='w-screen pt-[8rem] h-[33rem]  flex justify-center  gap-[5rem] items-center  max-[425px]:w-[20rem] max-[1025px]:h-[61rem] max-[1025px]:flex-col '>
