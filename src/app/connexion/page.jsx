  ...
  const [mdp, setmdp] = useState("")
    ...
    return(
        <div className="min-w-screen  min-h-screen flex  items-center flex-col ">
            ...
            <div className="w-[30rem]  h-[30rem] rounded-xl bg-[#0E0E0E] flex flex-col items-center justify-center gap-5 bglogin boxshadow max-[426px]:w-[22rem] max-[426px]:h-[30rem]">
                ...
                <button onClick={conect} className="btn text-xl bg-[#E08821]">Connect</button>
                </div>
            </div>
        </div>
)}